...
from fq.fastq import FastqFile
...
def test_fastq_file_copy(tmp_path):
    inpath = files("fq") / "tests" / "data" / "flat" / "test1_S1_L001_R1_001.fastq.gz"
...
def test_fastq_file_check_and_copy(tmp_path):
    ...
    inpath = files("fq") / "tests" / "data" / "flat" / "test1_S1_L001_R2_001.fastq.gz"
